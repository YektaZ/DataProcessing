...
function [Vx_avg, Vy_avg, Xvel_SEM, Yvel_SEM, Avg_Time, Speed_avg, Speed_SEM] = AVGES_5(indices,Data,fs)
...
if indices
    ...
    for j = indices
        ...
        Speed_Sum = Speed_Sum + sqrt(Data.XVelocity{j}(idx).^2 + Data.YVelocity{j}(idx).^2);
    ...
    for j = indices
        ...
        Speed_SS = Speed_SS + (sqrt(Data.XVelocity{j}(idx).^2 + Data.YVelocity{j}(idx).^2) - Speed_avg).^2;
